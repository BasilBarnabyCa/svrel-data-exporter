...
engine_processing = sqlalchemy.create_engine(
    f"mysql+pymysql://{db_config_processing['user']}:{db_config_processing['password']}@{db_config_processing['host']}:{db_config_processing['port']}/{db_config_processing['database']}"
)
engine_sql_execution = sqlalchemy.create_engine(
    f"mysql+pymysql://{db_config_sql_execution['user']}:{db_config_sql_execution['password']}@{db_config_sql_execution['host']}:{db_config_sql_execution['port']}/{db_config_sql_execution['database']}"
)
...
# DELETE AND RECREATE EXPORT DIRECTORIES
if os.path.exists("exports"):
    shutil.rmtree("exports")  # Remove the entire 'exports' folder
    print("Deleted 'exports' directory.")
